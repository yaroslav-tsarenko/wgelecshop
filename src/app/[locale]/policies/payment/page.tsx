...
export const metadata = { title: "Payment Policy — WGELECSHOP" };
  ...
  return (
    <PolicyLayout title="Payment Policy" lastUpdated="29 May 2026">
      <p>
        ...
        for purchases made through www.wgelecshop.com.
      </p>
      ...
      <p>
        1.2 WGELECSHOP sells electrical products, electrical materials, wiring accessories, lighting-related
      ...
      <p>
        2.5 WGELECSHOP does not control exchange rates, bank conversion fees, card issuer charges, or foreign
        transaction fees.
      </p>
      ...
      <p>
        3.4 Price changes will not affect orders already accepted by WGELECSHOP, except where there has been
      ...
      <p>4.1 WGELECSHOP accepts secure card payments using:</p>
      <ul>
        <li>Visa</li>
        <li>Mastercard</li>
      </ul>
      ...
      <p>
        5.3 WGELECSHOP does not guarantee that your payment will be accepted. Payment approval depends on
      ...
      <p>6.1 WGELECSHOP takes payment security seriously.</p>
      <p>
        6.2 Card payments are handled through secure third-party payment providers. WGELECSHOP does not store
      ...
      <p>
        8.2 WGELECSHOP is not responsible for payment failures caused by your bank, card issuer, payment
      ...
      <p>
        9.1 To protect customers, WGELECSHOP, payment providers, and card networks, transactions may be
      ...
      <p>
        10.3 Where applicable, WGELECSHOP may issue order confirmations, payment confirmations, receipts, VAT
      ...
      <p>12.1 WGELECSHOP dispatches orders from the United Kingdom.</p>
      <p>
      ...
      <p>
        ...
        in the product price, delivery price, or payment collected by WGELECSHOP.
      </p>
      <p>
      ...
      <p>
        12.5 WGELECSHOP does not control customs authorities, customs delays, import tax assessments, courier
      ...
      <p>
        ...
        is required by law or approved by WGELECSHOP, the related Additional Warranty charge may also be
        refunded.
      </p>
      ...
      <p>
        ...
        are not controlled by WGELECSHOP and are not refundable by WGELECSHOP.
      </p>
      <p>
        15.6 Customs duties, import VAT, local taxes, brokerage fees, courier handling fees, customs
        clearance fees, and other local charges are not charged by WGELECSHOP and are not refundable by
        WGELECSHOP.
      </p>
      ...
      <p>
        ...
        should contact us first at info@wgelecshop.com so we can investigate and try to resolve the issue.
      </p>
      <p>
      ...
      <p>
        17.2 WGELECSHOP does not offer credit terms, open account purchasing, or deferred payment to Business
