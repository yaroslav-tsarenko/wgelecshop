...
export const metadata = { title: "Shipping Policy — WGELECSHOP" };

export default function ShippingPolicyPage() {
  return (
    <PolicyLayout title="Shipping Policy" lastUpdated="29 May 2026">
      <p>
        This Shipping Policy explains how orders placed through www.wgelecshop.com are processed,
      ...
      <p>
        ...
        means WGELECSHOP LTD. &ldquo;Customer&rdquo;, &ldquo;you&rdquo; or &ldquo;your&rdquo; means the
      ...
      <p>1.1 This Policy applies to the delivery of physical goods purchased through WGELECSHOP.</p>
      <p>
      ...
      <p>3.1 WGELECSHOP dispatches orders from the United Kingdom.</p>
      <p>
      ...
      <p>
        5.4 WGELECSHOP is not responsible for delays caused by customs authorities, local postal operators,
      ...
      <p>
        7.3 WGELECSHOP is not responsible for delays, failed deliveries, lost parcels, return charges, or
      ...
      <p>
        8.1 WGELECSHOP may accept international orders to supported delivery destinations shown on the
      ...
      <p>
        9.3 WGELECSHOP does not control customs authorities, import tax assessments, duty rates, customs
      ...
      <p>
        12.4 WGELECSHOP is not responsible for failed delivery where you do not respond to courier notices, do
      ...
      <p>
        ...
        extended period, please contact us at info@wgelecshop.com.
      </p>
      <p>
      ...
      <p>
        16.2 WGELECSHOP is not responsible for loss, damage, delay, customs issues, onward shipping problems,
      ...
      <p>
        17.3 WGELECSHOP is not responsible for labour costs, electrician costs, contractor costs, installation
